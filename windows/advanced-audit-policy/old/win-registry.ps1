<#
PLURA-Forensic
Registry auditing (SACL) applier for PLURA - Registry1 (This key only)
...
$RepoDesktopRuleUrl = 'https://repo.plura.io/edr/windows/advanced-audit-policy/desktop/d-audit-registry1.rules'
$RepoServerRuleUrl  = 'https://repo.plura.io/edr/windows/advanced-audit-policy/server/s-audit-registry1.rules'
...
try {
    ...
    if ($useRules) {
        ...
        Write-Log -Level 'INFO' -Message "Applying Registry auditing (SACL) - Registry1 (This key only)"
    ...
    Write-Log -Level 'INFO' -Message "Applying Registry auditing (SACL) - Registry1 (This key only) - single target"
