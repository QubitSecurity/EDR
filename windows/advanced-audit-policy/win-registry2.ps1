<#
PLURA-Forensic
Registry auditing (SACL) applier for PLURA - Registry2 (Subkeys only)
...
$RepoDesktopRuleUrl = 'https://repo.plura.io/edr/windows/advanced-audit-policy/desktop/d-audit-registry2.rules'
$RepoServerRuleUrl  = 'https://repo.plura.io/edr/windows/advanced-audit-policy/server/s-audit-registry2.rules'
...
try {
    ...
    Write-Log -Level 'INFO' -Message "Applying Registry auditing (SACL) - Registry2 (Subkeys only) - single target"
