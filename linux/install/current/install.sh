...
download_package ()
{
        curl -s https://repo.plura.io/v6/$1/manifest -o manifest
        if [ ! -f manifest ]; then
        ...
        do
                ...
                curl -s https://repo.plura.io/v6/$1/$file -o $file
...
config_commanx ()
{
        ...
        echo "arch=$1" > arch
        #
        curl -s https://repo.plura.io/v6/module/plura/conf/plura-commax.sh -o plura.sh
        chmod +x plura.sh
}
...
config ()
{
        case $TARGET in
                ...
                commax64)
                        ...
                        ;;
                logcollector|PLC)
                        curl -s https://repo.plura.io/v6/module/rsyslog/80-udp.conf -o /etc/rsyslog.d/80-udp.conf
